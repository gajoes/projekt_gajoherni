  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
    <div class="container-fluid">
      <a class="navbar-brand d-flex align-items-center" href="#">
        <img src="./css/img/Tech.png" width="30" height="30" class="d-inline-block align-top" alt="Jurzyk">
        <span class="navbar-custom-font fs-3 ms-2 fw-bold text-primary">BYTE</span>
      </a>
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class="nav-link" href="./index.php">Strona główna <span class="visually-hidden">(Aktualnie
                włączone)</span></a>
          </li>
          <li class="nav-item">
