                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" class="d-inline">
                            ...
                            <input type="text" name="tytul" value="<?php echo htmlspecialchars($aktualnosc['tytul']); ?>" class="form-control form-control-sm mb-1" required>
                            <textarea name="tresc" class="form-control form-control-sm mb-1" rows="2" required><?php echo htmlspecialchars($aktualnosc['tresc']); ?></textarea>
                            <button type="submit" name="edit_news" class="btn btn-warning btn-sm w-100 mb-2">Edytuj</button>
                        </form>
                        <form method="POST" class="d-inline">
                            <input type="hidden" name="id" value="<?php echo $aktualnosc['id_aktualnosci']; ?>">
