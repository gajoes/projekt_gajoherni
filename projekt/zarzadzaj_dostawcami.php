    ...
    <div class="card bg-white mb-5 text-dark text-center border-light shadow-sm">
        <div class="card-body">
            ...
            <form method="POST" class="row g-3">
                <div class="col-md-6">
                    <input type="text" name="nazwa_dostawcy" class="form-control" placeholder="Nazwa dostawcy" required>
                </div>
                <div class="col-md-6">
                    <input type="text" name="kraj_pochodzenia" class="form-control" placeholder="Kraj pochodzenia" required>
                </div>
                <div class="col-12 text-center">
                    <button type="submit" name="add_supplier" class="btn btn-primary w-50 buy">Dodaj dostawcę</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" class="d-inline">
                            ...
                            <input type="text" name="nazwa_dostawcy" value="<?php echo htmlspecialchars($supplier['nazwa_dostawcy']); ?>" class="form-control form-control-sm mb-1" required>
                            <input type="text" name="kraj_pochodzenia" value="<?php echo htmlspecialchars($supplier['kraj_pochodzenia']); ?>" class="form-control form-control-sm mb-1" required>
                            <button type="submit" name="edit_supplier" class="btn btn-warning btn-sm w-100 mb-2">Edytuj</button>
                        </form>
                        <form method="POST" class="d-inline">
                            <input type="hidden" name="id_dostawcy" value="<?php echo $supplier['id_dostawcy']; ?>">
                            <button type="submit" name="delete_supplier" class="btn btn-danger btn-sm w-100">Usuń</button>
                        </form>
                    </td>
                </tr>
            <?php endwhile; ?>
